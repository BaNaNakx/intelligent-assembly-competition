...
task_card_capture_timeout_s = 12.5
...
class SettingsTests(unittest.TestCase):
    def test_loads_all_pre_competition_network_values(self) -> None:
        ...
        self.assertEqual(config.tcp.task_card_image_directory, "C:/VM/cards")
        self.assertEqual(config.tcp.task_card_capture_timeout_s, 12.5)
